<!-- //Line Slider -->
		<div class="top_banner">
			...
			<div class="sleekslider">
				...
				<nav class="tabs">
					<div class="tab-container">
						<ul>
							<li class="current"><a><span>01</span> Slide</a></li>
							<li><a><span>02</span> Slide</a></li>
							<li><a><span>03</span> Slide</a></li>
							<li><a><span>04</span> Slide</a></li>
							<li><a><span>05</span> Slide</a></li>
						</ul>
					</div>
				</nav>
			</div>
			...
			<!-- JavaScripts -->
			<script type="text/javascript" src="<?php echo base_url().'assets/js/sleekslider.min.js' ?>"></script>
