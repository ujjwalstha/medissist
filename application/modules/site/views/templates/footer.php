					...
					<div class="col-md-3 footer-grid flickr">
						...
						<div class="flickr-grids">
							<div class="flickr-grid">
								<a href="#"><img src="<?php echo base_url().'assets/images/t1.jpg' ?>" alt=" " title="CEO" /></a>
							</div>
							<div class="flickr-grid">
								<a href="#"><img src="<?php echo base_url().'assets/images/t2.jpg' ?>" alt=" " title="GM" /></a>
							</div>
							<div class="flickr-grid">
								<a href="#"><img src="<?php echo base_url().'assets/images/t3.jpg' ?>" alt=" " title="CEO" /></a>
							</div>
							<div class="clearfix"> </div>
							...
							<div class="flickr-grid">
								<a href="#"><img src="<?php echo base_url().'assets/images/t1.jpg' ?>" alt=" " title="GM" /></a>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
